...
FROM
    ...
    LEFT JOIN concept_name question_concept_short_name ON question_concept_name.concept_id = question_concept_short_name.concept_id
        ...
        IS FALSE
    WHERE
        question_concept_name.name IN ('CBIMNCI <2-PSBI/LBI/NBI-PSBI' , 
        'CBIMNCI <2-PSBI/LBI/NBI-LBI', 
        'CBIMNCI <2-PSBI/LBI/NBI-NBI', 
        'CBIMNCI <2-PSBI/LBI/NBI-Jaundice', 
        'Breastfed', 
    ...
    and p.voided=0
    WHERE
    cn1.name IN ('CBIMNCI <2-PSBI/LBI/NBI-PSBI' , 
        'CBIMNCI <2-PSBI/LBI/NBI-LBI', 
        'CBIMNCI <2-PSBI/LBI/NBI-NBI', 
        'CBIMNCI <2-PSBI/LBI/NBI-Jaundice', 
        'Breastfed', 
