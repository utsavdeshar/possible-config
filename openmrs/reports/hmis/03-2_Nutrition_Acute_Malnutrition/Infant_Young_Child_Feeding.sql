...
From
(SELECT
  If(onlyBreastFeeding.question_full_name = 'Nutrition note-Only breast feeding for 6 months', 'Excl. breast feeding',
...
WHERE !p.voided AND
      ...
      AND (onlyBreastFeeding.question_full_name IN
           ('Nutrition note-Only breast feeding for 6 months', 'Nutrition note-Breast feeding and light food'))
